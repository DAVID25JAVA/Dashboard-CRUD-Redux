    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="max-w-4xl w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <p className="text-gray-600 mb-4 leading-relaxed">
          ...
          This application demonstrates fetching data from a public API and managing it using
          <span className="font-medium"> Redux Toolkit</span>.
        </p>

        <p className="text-gray-600 mb-6 leading-relaxed">
          You can perform full CRUD operations (Create, Read, Update, Delete) on posts, with centralized state management and a clean dashboard view.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="border rounded-lg p-4 flex flex-col justify-between shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-gray-700">Posts Dashboard</h3>
            </div>
